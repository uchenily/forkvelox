  ...
  void apply(const SelectivityVector &rows, std::vector<VectorPtr> &args,
    ...
    if (left && right) {
      ...
      throw std::runtime_error(
          "EqFunction only supports SimpleVector<int64> for now");
    }
    result = flat;
  }
};
...
public:
  void apply(const SelectivityVector &rows, std::vector<VectorPtr> &args,
    ...
    if (left && right) {
      ...
      throw std::runtime_error(
          "NeqFunction only supports SimpleVector<int64> for now");
    }
    result = flat;
  }
};
...
public:
  void apply(const SelectivityVector &rows, std::vector<VectorPtr> &args,
    ...
    if (left && right) {
      ...
      throw std::runtime_error(
          "LtFunction only supports SimpleVector<int64> for now");
    }
    result = flat;
  }
};
...
public:
  void apply(const SelectivityVector &rows, std::vector<VectorPtr> &args,
    ...
    if (left && right) {
      ...
      throw std::runtime_error(
          "GtFunction only supports SimpleVector<int64> for now");
    }
    result = flat;
  }
};
...
public:
  void apply(const SelectivityVector &rows, std::vector<VectorPtr> &args,
    ...
    if (left && right) {
      ...
      throw std::runtime_error(
          "LteFunction only supports SimpleVector<int64> for now");
    }
    result = flat;
  }
};
...
public:
  void apply(const SelectivityVector &rows, std::vector<VectorPtr> &args,
    ...
    if (left && right) {
      ...
      throw std::runtime_error(
          "GteFunction only supports SimpleVector<int64> for now");
    }
    result = flat;
  }
};
