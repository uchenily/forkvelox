...
[[noreturn]] void veloxCheckFail(const char *file, int line, const char *expr, std::format_string<Args...> fmt,
                                 Args &&...args) {
...
#define VELOX_FAIL(...) ::facebook::velox::detail::veloxCheckFail(__FILE__, __LINE__, "FAIL", __VA_ARGS__)
