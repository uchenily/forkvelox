...
public:
  LambdaExpr(RowTypePtr signature, ExprPtr body, std::vector<std::string> captures, TypePtr type)
      : Expr(std::move(type), {}, "lambda"), signature_(std::move(signature)), body_(std::move(body)),
